# Generated by Django 3.1.3 on 2021-10-30 20:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bounty', models.CharField(blank=True, help_text='Award/bounty given to the person who will return the item. Make sure that you are in possession of the award. <br> This is optional but can be used as motivation.', max_length=100, verbose_name='Bounty')),
                ...
                ('bookmarkers', models.ManyToManyField(blank=True, related_name='bookmarked_lost_items', related_query_name='bookmarked_lost_item', to=settings.AUTH_USER_MODEL)),
                ('contact_numbers', models.ManyToManyField(related_name='_lostitem_contact_numbers_+', to='users.PhoneNumber', verbose_name='Contact numbers')),
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lost_items', related_query_name='lost_item', to='core.institution')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lost_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photos', related_query_name='photo', to='lost_or_found.lostitem')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarkers', models.ManyToManyField(blank=True, related_name='bookmarked_found_items', related_query_name='bookmarked_found_item', to=settings.AUTH_USER_MODEL)),
                ('contact_numbers', models.ManyToManyField(related_name='_founditem_contact_numbers_+', to='users.PhoneNumber', verbose_name='Contact numbers')),
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='found_items', related_query_name='found_item', to='core.institution', verbose_name='School')),
            ],
            options={
                'ordering': ['-posted_datetime'],
            },
