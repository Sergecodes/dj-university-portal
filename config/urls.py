...
# handler404 = 'core.views.views.page_not_found_view'
handler500 = 'core.views.views.server_error_view'
# handler403 = 'core.views.views.permission_denied_view'
# handler400 = 'core.views.views.bad_request_view'
