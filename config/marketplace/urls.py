...
urlpatterns = [
	...
	path(_('items/<slug:slug>/'), views.ItemListingDetail.as_view(), name='item-listing-detail'),
	...
	path(_('adverts/<slug:slug>/'), views.AdListingDetail.as_view(), name='ad-listing-detail'),
